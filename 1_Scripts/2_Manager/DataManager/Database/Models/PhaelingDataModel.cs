...
public partial class PhaelingDataModel : IEquatable<PhaelingDataModel>
{
    ...
    public PhaelingDataModel() { }

    /// <summary>
    /// Copy ctor for deep clone of all fields
    /// </summary>
    public PhaelingDataModel(PhaelingDataModel other)
    {
    ...
    public bool Equals(PhaelingDataModel other)
    {
    ...
    {
        return obj is PhaelingDataModel other && Equals(other);
    }
    ...
    public static PhaelingDataModel operator +(PhaelingDataModel a, PhaelingDataModel b)
    {
        if (a == null) return b;
        if (b == null) return a;
        var result = new PhaelingDataModel(a);
